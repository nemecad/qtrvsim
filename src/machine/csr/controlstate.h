...
namespace machine { namespace CSR {
    ...
    namespace Field {
        namespace mstatus {
            ...
            static constexpr RegisterFieldDesc MXR
                = { "MXR", Id::MSTATUS, { 1, 19 }, "Make eXecutable Readable (treat X pages as readable for loads)" };
        ...
        namespace sstatus {
            static constexpr RegisterFieldDesc SIE
                = { "SIE", Id::SSTATUS, { 1, 1 }, "Supervisor global interrupt-enable (alias of mstatus.SIE)" };
            static constexpr RegisterFieldDesc SPIE
                = { "SPIE", Id::SSTATUS, { 1, 5 }, "Previous SIE before the trap (alias of mstatus.SPIE)" };
            static constexpr RegisterFieldDesc SPP
                = { "SPP", Id::SSTATUS, { 1, 8 }, "Supervisor previous privilege mode (alias of mstatus.SPP)" };
            static constexpr RegisterFieldDesc SUM
                = { "SUM", Id::SSTATUS, { 1, 18 }, "Permit Supervisor access to User memory (alias of mstatus.SUM)" };
            static constexpr RegisterFieldDesc MXR
                = { "MXR", Id::SSTATUS, { 1, 19 }, "Make eXecutable Readable (alias of mstatus.MXR)" };
            static constexpr RegisterFieldDesc UXL
                = { "UXL", Id::SSTATUS, { 2, 32 }, "User mode XLEN (RV64 only) (alias)" };
            static constexpr RegisterFieldDesc SXL
                = { "SXL", Id::SSTATUS, { 2, 34 }, "Supervisor mode XLEN (RV64 only) (alias)" };
            static constexpr const RegisterFieldDesc *fields[]
                = { &SIE, &SPIE, &SPP, &UXL, &SXL };
            static constexpr unsigned count = sizeof(fields) / sizeof(fields[0]);
        } // namespace sstatus
        namespace satp {
            // RV32 Layout
    ...
    inline constexpr std::array<RegisterDesc, Id::_COUNT> REGISTERS {
        { // Unprivileged Counter/Timers
          ...
          [Id::MEDELEG] = { "medeleg", 0x302_csr, "Machine exception delegation register.", 0, 0xfffef7ff },
          [Id::MIDELEG] = { "mideleg", 0x303_csr, "Machine interrupt delegation register.", 0, 0xffffffff },
          ...
          // Machine Configuration
          [Id::MENVCFG] = { "menvcfg", 0x30A_csr, "Machine environment configuration register.", 0, 0xffffffff },
          [Id::MENVCFGH] = { "menvcfgh", 0x31A_csr, "Upper 32 bits of menvcfg, RV32 only.", 0, 0xffffffff },
          //Machine Memory Protection
          [Id::PMPCFG0] = { "pmpcfg0", 0x3A0_csr, "Physical memory protection configuration.", 0, 0xFFFFFFFF },
          [Id::PMPADDR0] = { "pmpaddr0", 0x3B0_csr, "Physical memory protection address register.", 0, 0xFFFFFFFC },
