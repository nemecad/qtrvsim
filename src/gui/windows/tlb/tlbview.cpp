...
void TLBAddressBlock::tlb_update(unsigned, unsigned set, bool, unsigned, quint64, quint64,
...
void TLBViewBlock::tlb_update(
    ...
    vpn[set]->setText(valid ? QString("0x%1").arg(QString::number(vpn_v, 16).toUpper()) : QString());
    phys[set]->setText(valid ? QString("0x%1").arg(QString::number(phys_v, 16).toUpper()) : QString());
